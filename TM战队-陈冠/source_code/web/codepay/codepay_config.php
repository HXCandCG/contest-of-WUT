...
$codepay_config['go_url'] =  $_SERVER[''] == '80' ? '/' : '//'.'web/Homepage.php'; 
 ...
 *
 */
define('DB_USERTABLE', 'customer');  //充值用户所在数据库表名
define('DB_USERMONEY', 'money');  //充值用户所在表中的金额字段名
define('DB_USERNAME', 'nickname');  //充值用户名的字段名 根据用户名转换为id
